...
public class PostController {
	...
	public String postList(Model model) {
		...
		model.addAttribute("allPostCnt" , postService.getAllPostCnt()); // 전체 게시글 수 전달 (Map<String,Object> 타입)
		model.addAttribute("postListMap" ,  postService.getPostList());	// 게시판관련정보 전달 (List<Map<String,Object>> 타입)
